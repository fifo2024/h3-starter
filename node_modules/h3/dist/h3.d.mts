...
type MaybePromise$1<T = unknown> = T | Promise<T>;
//#endregion
...
//  --- middleware ---
type Middleware = (event: H3Event, next: () => MaybePromise$1<unknown | undefined>) => MaybePromise$1<unknown | undefined>;
// --- lazy event handler ---
...
interface H3Config {
  ...
  */
  silent?: boolean;
  plugins?: H3Plugin[];
  onRequest?: (event: H3Event) => MaybePromise$1<void>;
  onResponse?: (response: Response, event: H3Event) => MaybePromise$1<void>;
  onError?: (error: HTTPError, event: H3Event) => MaybePromise$1<void | unknown>;
}
...
declare class H3$1 {
  ...
  */
  ...
  /** @internal */
  _getMiddleware(event: H3Event, route: MatchedRoute<H3Route> | undefined): Middleware[];
  /** @internal */
  _normalizeMiddleware(fn: Middleware, _opts?: MiddlewareOptions & {
    route?: string;
  }): Middleware;
  /** @internal */
...
declare class H3 extends H3Core {
  ...
  _findRoute(_event: H3Event): MatchedRoute<H3Route> | void;
  _addRoute(_route: H3Route): void;
  _normalizeMiddleware(fn: Middleware, opts?: MiddlewareOptions & {
    route?: string;
  }): Middleware;
}
//#endregion
